window.QUIZ_DATA = {
    ...
    "dimExplanations": {
        ...
        "S2": {
            "L": "随波逐流的 NPC，人生的主线任务全靠周围人发布，日常陷入“我到底想要啥”的哲学迷思，极易被洗脑。",
            "M": "处于“薛定谔的觉醒”状态，偶尔在深夜对未来有极度清晰的规划，第二天早上闹钟一响又变回了没有灵魂的打工尸体。",
            "H": "人间清醒本醒，雷达极其敏锐，别人还在迷茫找北，你已经把真正想要的东西和人生大纲死死刻在DNA里了。"
        },
        "S3": {
            "L": "讨好型打工人预备役，把别人的评价当圣旨，别人一个微小的皱眉，你已经在心里给自己判了无期徒刑。",
            "M": "既想在世俗意义上卷出头，又偶尔渴望隐居终南山，在“去他妈的眼光”和“求点赞求夸夸”之间反复横跳。",
            "H": "无情的向上攀爬机器或满级脱俗者，外人的评价在你眼里全是毫无价值的报错代码，只向着自己的野心狂飙。"
        },
        "E1": {
        ...
        "G1": {
            "L": "课程表像催命符，专业认同感全靠“来都来了”和“不想补考”强撑。",
            "M": "绩点守护者，老师指哪打哪，是稳在专业平均线上的知识搬运工。",
            "H": "专业课已经装不下你了，在领域内自带一种“主场作战”的降维打击感。"
        },
        "G2": {
            "L": "脆皮心态，内卷的风还没刮到脸上，人已经先在寝室emo断网了。",
            "M": "典型的稳健派，嘴上喊着“要完”，手下的ddl和考试周倒也没真翻车。",
            "H": "反脆弱体质，越是修罗场越是两眼放光，压力越大你的CPU转得越快。"
        },
        "G3": {
            "L": "长期处于“生涯断网”状态，对未来的唯一规划就是“走一步算一步”。",
            "M": "拿着主流剧本，按部就班走在考研或实习的大路上，基本不出圈。",
            "H": "野心和嗅觉都挂了五档，还没毕业就已经把社会的坑位算计得明明白白。"
        },
        "V1": {
            "L": "标准“脆皮大学生”，熬半宿得缓一周，身体基建基本靠咖啡因和奶茶强行吊命。",
            "M": "充电两小时通话一整天，平时随缘养生，遇到ddl也能进ICU前强行爆发一下。",
            "H": "铁人精神，通宵肝完项目还能神采奕奕去面试，身体里仿佛装了核能电池。"
        },
        "V2": {
            "L": "短视频重度患者，五分钟不刷手机就坐立难安，深度思考能力常年处于关机状态。",
            "M": "在图书馆需要一个小时“入定”，状态进去了也算能打，但会被室友一个电话瞬间破功。",
            "H": "激光式专注，一旦开启工作模式，周围的八卦和手机震动会被大脑物理屏蔽。"
        },
        "V3": {
            "L": "情绪黑洞，除了“烦”就是“累”，一旦受挫就想原地躺平，甚至想去衡山路大喊大叫。",
            "M": "具备基础自愈力，知道什么时候该去大吃一顿或看场电影，给快要过热的CPU降降温。",
            "H": "冷酷的逻辑机器，能迅速解析压力来源，把负面情绪瞬间转化成解决问题的燃料。"
        },
        "I1": {
            "L": "全村最后一个知道消息的人，选课全凭运气，实习全看室友，完美错过所有红利期。",
            "M": "资深群聊潜水员，混迹于各大选课群和闲鱼，能跟上大部队的节奏，不至于掉队。",
            "H": "人间爬虫，能从导师的只言片语或校友会的陈年文档里扒出最有含金量的“隐形机会”。"
        },
        "I2": {
            "L": "手动挡玩家，查资料只看百度，还在用最笨的方法处理数据，对生产力工具毫无兴趣。",
            "M": "AI 辅助选手，熟练运用各类插件和Prompt，能把三天的作业量压缩到三小时完成。",
            "H": "极客流，能用脚本解决的绝不动手，把AI和各种协同软件玩成了自己的“数字分身”。"
        },
        "I3": {
            "L": "纯血“伸手党”，对金钱和资源毫无概念，总觉得社会化是毕业后才需要考虑的苦难。",
            "M": "有过实习或兼职经历，对“等价交换”有了初步敬畏，正在练习如何给自己的时间定价。",
            "H": "社会化预演完成体，还没毕业就自带老板心态，擅长拿学校资源换社会履历，金钱观极其成熟。"
        }
    }
};