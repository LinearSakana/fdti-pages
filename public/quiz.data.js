window.QUIZ_DATA = {
    ...
    "dimExplanations": {
        ...
        "G1": {
            "L": "对所学专业缺乏归属感或兴趣，常感到学业吃力，学习动力主要来自外界压力或及格线，容易产生‘专业错位’的自我怀疑。",
            "M": "能够胜任日常课业任务，专业基础较稳固。通常按照教学大纲平稳推进，但在学术深挖或跨学科应用上缺乏强烈的个人主见。",
            "H": "具有极强的专业认同与效能感，能够自主进行深度研究或项目实战，在专业领域内有明显的掌控欲和成就导向。"
        },
        "G2": {
            "L": "面对高强度内卷、挂科风险或突发性挫折时容易产生习得性无助，情绪波动较大，抗压阈值低，常伴有严重的拖延或逃避行为。",
            "M": "面对常规学业压力（如ddl、考试周）能维持稳定，在受挫后需要一定时间缓冲，基本能做到在波动中维持功能的正常运作。",
            "H": "具备极强的心理韧性与‘反脆弱’特质。视竞争压力为成长的磨刀石，在逆境中恢复速度极快，甚至能在高压环境下爆发更强的执行力。"
        },
        "G3": {
            "L": "对未来缺乏清晰愿景，处于生涯探索的停滞期。表现为‘随大流’，对考研、就业或创业等选择感到迷茫，行动力受制于当下的安逸。",
            "M": "有大致的职业或深造方向，倾向于遵循社会主流的成功路径。虽然具备一定的规划意识，但在面对复杂变局时缺乏长远的战略思考。",
            "H": "生涯目标极其明确且具有前瞻性。能够独立规划发展路径（如早早布局实习、科研或创业），具备极强的职业野心和跨越阶层的动能。"
        },
